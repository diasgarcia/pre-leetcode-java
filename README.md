...
Trilha progressiva de algoritmos e estruturas de dados em Java para quem já
...
```text
pre-leetcode-java/
├── teoria/             ← conteúdo dos módulos iniciados
├── src/main/java/      ← exercícios e infraestrutura de testes
├── src/test/java/      ← testes unitários da infraestrutura
...
| `/validar` | Compila e executa os testes. |
