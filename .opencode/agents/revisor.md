...
- Há erros de índice (`ArrayIndexOutOfBounds`)?
- Array vazio é tratado?
- Números negativos funcionam?
- Usa estruturas ainda não ensinadas?
- Usa Streams quando proibido?
- Usa lambdas quando proibido?
- Usa métodos prontos que eliminam o objetivo pedagógico?
