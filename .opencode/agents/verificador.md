...
| Item | Pergunta-chave |
|---|---|
| **Nomes** | Variáveis e métodos são claros, em português e expressam intenção? |
...
| **Restrições** | Respeita as proibições do enunciado (Streams, ordenação, estruturas proibidas)? |
