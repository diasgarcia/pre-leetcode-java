...
2. Leia `README.md`.
3. Leia `PROGRESSO.md`.
4. Identifique: módulo atual, exercício atual, arquivo Java, status.
...
```
COMPILACAO: APROVADA ou REPROVADA
TESTES: APROVADOS ou REPROVADOS
```

Se compilação ou testes falharem:
- Não chame o criador.
...
Se compilação e testes passarem, chame o subagente `revisor`. Ele deve retornar:
...
- Nunca implemente o método pendente do aluno.
